...
$p=new produit();	
$res=$p->afficher_produit($_GET['id']);
$row=$res->fetch();
				...
				<div class="row">
					...
					<div class="col-lg-6 col-12">
						<div class="my__account__wrapper">
							<h3 class="account__title">Modify PRODUCT</h3>
							<form action="PHP/Controller/modifproduitform.php" method="post" enctype="multipart/form-data">
								...
								<div class="input__box">
										...
										<input type="text" name="desig" value= "<?php	echo $row[1];?>">
									</div>
									<div class="input__box">
									...
									<div class="input__box">
										...
										<input type="text" name="carac" value= "<?php	echo $row[3];?>">
									</div>
									...
									<div class="input__box">
										...
										<img	src="images/books/<?php	echo $row['img'];?> "	>
							...
							margin: 4px 3px 3px 8px;
									...
									<!-- <input type="submit" value="REGISTER"> -->
										...
										<center><button>CONFIRMER</button></center>
									</div>
								</div>
							</form>
						</div>
