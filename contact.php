        		...
        		<div class="row">
        			<div class="col-lg-8 col-12">
        				<div class="contact-form-wrap">
                            ...
                            <form action="PHP/Controller/verifcontact.php" method="post">
	    ...
	    <script>
	        ...
	        function init() {
	            ...
	            var mapOptions = {
	                ...
	                center: new google.maps.LatLng(34.7577562, 10.77218793), // New York
	            ...
	            var marker = new google.maps.Marker({
	                position: new google.maps.LatLng(34.7577562, 10.77218793),
	                map: map,
	                title: 'Dcare!',
