                                ...
                                <table>
                                    <thead>
                                        <tr class="title-top">
                                            ...
                                            <th class="product-quantity">Caractéristique</th>
				 ...
				 foreach($res1 as $row)
                                    ...
                                    <tbody>
                                        <tr>     
                                            ...
                                            <td class="product-remove"><a href="PHP/Controller/suppform.php?id=<?php echo $row[0];?>">X</a></td> 
                                            <td class="product-remove"><a href="produit_information.php?id=<?php echo $row[0];?>"><img src="images/books/modif.png" height="15" width="15"></a></td> 
