                    ...
                    <div class="col-md-12 col-sm-12 ol-lg-12">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-thumbnail"><a href="#"><img src="images/books/<?php	echo $row['img'];?>" alt="product img"></a></td>
                                            <td class="product-name"><a href="#"><?php	echo $row[1];?></a></td>
                                            <td class="product-price"><span class="amount"><?php	echo $row[2];?>$</span></td>
                                            <td class="product-quantity"><input type="number" value="1" id="q"></td>
                                            <td class="product-subtotal" id="demo" ><?php echo $row[2];?></td>
                                            <td class="product-remove"><a href="delatecartprod.php?id=<?php echo $row[0];?>">X</a></td>  
                                        </tr>
                                         ...
                                         <?php  } 
											...
											?>
                                             ...
                                             <script>
												...
												$(document).ready(function(){
												$("#q").nextAll().change(function(){ 
												var y = parseInt($(".amount").text(), 10);
                        ...
                        <div class="cartbox__btn">
                            <ul class="cart__btn__list d-flex flex-wrap flex-md-nowrap flex-lg-nowrap justify-content-between">
                                ...
                                <li><a href="<?php	 if (isset($_SESSION['emailcl'])&& isset($_SESSION['passcl']))	echo'endpayment.php';	else echo'account_login.php';?>">Check Out</a></li>
