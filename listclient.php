				 ...
				 foreach($res1 as $row)
                                    ...
                                    <tbody>
                                        <tr>     
                                            ...
                                            <td class="product-price"><span class="amount"><?php echo $row[6];?>$</span></td>
...
foreach($tab as $i)
echo"<label > $i <input type=checkbox name=loisir[] value='$i' checked/>	</label>";
$toutloisir=array("Fantasy","Science","Romance","Cookbooks","History");
$resttab=array_diff($toutloisir,$tab);
foreach($resttab as $h)
{
	echo"<label>$h <input type=checkbox name=loisir[] value='$h' /></label>";
...
?>
                                            ...
                                            <td class="product-remove"><a href="PHP/Controller/suppcl.php?id=<?php echo $row[0];?>">X</a></td> </tr>
