...
require_once('PHP/Model/Class/books.php');
	...
	$res2=$b->consulter_client($_SESSION['emailcl'],$_SESSION['passcl']);
											...
											<div class="switcher-options">
												<div class="switcher-currency-trigger">
													<div class="setting__menu">
														...
														<span><a href="PHP/Controller/logout.php">Logout</a></span>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="my__account__wrapper">
							<!--<h3 class="account__title">Login</h3>-->
								...
								<div class="account__form">
									<div class="form__btn">
									<?php  $res=$b->consulter_client_donnee($_SESSION['emailcl'],$_SESSION['passcl']);		
										$rows=$res->fetch();
										
										?>
										<button onclick="location.href='my_account_information.php?id=<?php  echo $rows[0];?>'">Modifier Information</button>
